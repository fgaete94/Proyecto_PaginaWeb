...
Dentro de la terminal, cambia al directorio "enfqx" escribiendo cd enfqx.
En esta carpeta deberías poder ver el archivo manage.py si listas los archivos (dir en Windows, ls en Mac/Linux).
...
Una vez que las dependencias se hayan instalado, inicia el servidor de desarrollo de Django con el comando:
